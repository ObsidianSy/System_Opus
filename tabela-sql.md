...
$$;
CREATE FUNCTION "obsidian"."processar_pedidos_ml"(IN p_import_id UUID, OUT vendas_inseridas INTEGER, OUT pedidos_processados INTEGER, OUT pedidos_cancelados_ignorados INTEGER, OUT vendas_revertidas INTEGER) RETURNS RECORD LANGUAGE PLPGSQL
AS
$$
